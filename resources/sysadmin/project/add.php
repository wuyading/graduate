                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <form id="sub_form" target="iframe_message" action="<?=toRoute('project/ajax_save_data')?>" method="post" enctype="multipart/form-data"">
                                <table class="table" style="width: 1100px;">
                                    ...
                                    <tr>
                                        <th><span style="color: red">*</span>带头人：</th>
                                        <td><input class="form-control" type="text" name="leader" value="<?=isset($info['leader']) ? $info['leader'] : ''?>" required></td>
                                    </tr>
                                    <tr>
                                        <th><span style="color: red">*</span>项目发起时间：</th>
                                        <td><input class="form-control laydate-icon" style="width: 180px;height: 30px;" type="text" name="start_time" onclick="laydate()" value="<?=isset($info['start_time']) ? date("Y-m-d H:i:s",$info['start_time']) : ''?>" required></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>项目概况:</th>
                                        <td>
                                            <textarea name="summary" id="" cols="100" rows="5"><?=isset($info['summary'])?$info['summary']:'';?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>内容：</th>
        ...
        <script type="text/javascript">
            ...
            function show_message(json) {
                if(json.status == 1001){
                    ...
                    window.location.href = "<?=toRoute('project')?>";
                }else{
                    layer.alert(json.msg);
                }
            }
